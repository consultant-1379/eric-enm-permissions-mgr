...
{{- define "eric-enm-permissions-mgr.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-enm-permissions-mgr.mergeAnnotations" -}}
  {{- include "eric-enm-permissions-mgr.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}

{{- define "eric-enm-permissions-mgr.mergeLabels" -}}
  {{- include "eric-enm-permissions-mgr.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
